...
router.post('/:id/slots/:slotId/reserve', authenticate, authorize('admin', 'doctor'), reserveSlot);
router.post('/:id/slots/:slotId/release', authenticate, authorize('admin', 'doctor'), releaseSlot);
